...
describe('ResultsComponent', () => {
  ...
  it('should create', () => {
    ...
    const request_resport = httpMock.expectOne( `http://localhost:9000/api/bets/chart-report`);
    expect(request_resport.request.method).toBe('GET');
    request_resport.flush(dummyReport);
